...
class Program
{
     ...
     * @Assert\NotBlank(message="Il manque un titre.")
     ...
     * @Assert\NotBlank(message="Il manque le sommaire.")
     * @Assert\Regex(
    ...
    /**
     * @ORM\OneToMany(targetEntity=Season::class, mappedBy="programs", orphanRemoval=true)
     */
    private $seasons;
